...
CCustomControlDlg::CCustomControlDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCustomControlDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CCustomControlDlg)
...
BEGIN_MESSAGE_MAP(CCustomControlDlg, CDialog)
	//{{AFX_MSG_MAP(CCustom ControlDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
